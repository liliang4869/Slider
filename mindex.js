...
export default class Slider extends Component{
    ...
    componentWillMount(){
      ...
      onPanResponderMove: (evt, gestureState) => {
        if(evt.nativeEvent.pageX<this.trackBarlayout.x){this.setState({leftLength:0});
        this.props.onDrag(0);return;}
        else if(evt.nativeEvent.pageX>this.trackBarlayout.x+this.trackBarLength){this.setState({leftLength:1});
        ...
        onLayout={(e)=>{
            ...
            onLayout={(e)=>{
                ...
                {backgroundColor:this.props.trackBarRightColor}]}/>
                 ...
                 <View style={[{height:20,width:20,borderRadius:10,backgroundColor:'#8deeee',position:'absolute',
